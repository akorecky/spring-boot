...
public class TodoRestControllerTests {
	...
	public void shouldReturnTodos() {
		ResponseEntity<List<Todo>> response = template.exchange("/api/todos", HttpMethod.GET, null,
	...
	public void shouldDeleteATodo() {
		ResponseEntity<Todo> response = template.exchange("/api/todos/1", HttpMethod.DELETE, null, Todo.class);
